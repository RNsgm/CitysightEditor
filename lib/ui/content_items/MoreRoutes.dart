...
class MoreRoutes extends ExpandedStatefulWidget {
  MoreRoutes({Key? key, required this.show}) : super(key: key);

  @override
  String idBlock = "more_routes";
  @override
  BlockType type = BlockType.MAP;

  @override
  State<MoreRoutes> createState() => _MoreRoutesState();
...
class _MoreRoutesState extends State<MoreRoutes> {
      ...
      builder: (context, child) {
        return widget.show.value ? Container(
          ...
          child: Column(
            ...
            children: [
              Text("Рекомендованные маршруты",style: containerLabel,),
