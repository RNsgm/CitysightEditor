...
class TextBlock extends ExpandedStatefulWidget {
  TextBlock({Key? key, this.values, required this.action, this.inDropzone = false}) : super(key: key);

  final TextEditingController _field = TextEditingController();

  @override
  String idBlock = "text_block";
...
class _TextBlockState extends State<TextBlock> with AutomaticKeepAliveClientMixin {
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: Text("Текстовый блок",style: containerLabel,)
                ), 
