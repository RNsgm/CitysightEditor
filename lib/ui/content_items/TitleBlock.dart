...
class TitleBlock extends ExpandedStatefulWidget {
  TitleBlock({Key? key, this.values, required this.action, this.inDropzone = false}) : super(key: key);

  final TextEditingController _field = TextEditingController();

  @override
  String idBlock = "title";
  @override
...
class _TitleBlockState extends State<TitleBlock> with AutomaticKeepAliveClientMixin {
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: Text("Заголовок",style: containerLabel,)
                ), 
